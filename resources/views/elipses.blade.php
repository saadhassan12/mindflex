...
<body>
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-1 py-1 py-lg-0">
        <a href="dashboard.html" class="navbar-brand p-0">

            <!-- Navbar with Ellipsis Menu -->
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-1 py-1 py-lg-0">
    <!-- Ellipsis Button -->
    <button class="btn ellipsis-menu-btn" id="ellipsis-menu-btn">
        <i class="fas fa-ellipsis-v"></i>
    </button>
    
    <!-- Ellipsis Menu -->
    <div class="ellipsis-menu" id="ellipsis-menu" style="display: none; position: absolute; top: 60px; left: 1px; background: white; border: 1px solid #ccc; border-radius: 1px; z-index: 5;">
        <a class="dropdown-item" href="#1">DASHBOARD</a>
...
<script>
    document.getElementById("ellipsis-menu-btn").addEventListener("click", function () {
        var menu = document.getElementById("ellipsis-menu");
    ...
    document.addEventListener("click", function (e) {
        var menu = document.getElementById("ellipsis-menu");
        var btn = document.getElementById("ellipsis-menu-btn");
